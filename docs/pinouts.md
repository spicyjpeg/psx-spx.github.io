...
- `DMASK` outputs the mask/"alpha" bit of the current pixel and is used by some
  ...
  mode.
- At least one official service manual has the labels for `VCLK_NTSC` and
  `VCLK_PAL` mistakenly swapped.
